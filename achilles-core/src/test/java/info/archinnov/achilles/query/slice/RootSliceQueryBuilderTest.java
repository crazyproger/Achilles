...
public class RootSliceQueryBuilderTest {
    ...
    public void should_get_first() throws Exception {
        ...
        ClusteredEntity actual = builder.partitionComponentsInternal(partitionKey).getFirstMatching();
    ...
    public void should_get_first_n() throws Exception {
        ...
        builder.partitionComponentsInternal(partitionKey).getFirstMatchingWithLimit(3);
    ...
    public void should_get_first_n_with_clustering_components() throws Exception {
        ...
        Object[] clusteringComponents = new Object[] { 1, "name" };
        builder.partitionComponentsInternal(partitionKey).getFirstMatchingWithLimit(3, clusteringComponents);
    ...
    public void should_get_last() throws Exception {
        ...
        ClusteredEntity actual = builder.partitionComponentsInternal(partitionKey).getLastMatching();
    ...
    public void should_get_last_n() throws Exception {
        ...
        builder.partitionComponentsInternal(partitionKey).getLastMatchingWithLimit(6);
    ...
    public void should_get_last_n_with_clustering_components() throws Exception {
        ...
        Object[] clusteringComponents = new Object[] { 1, "name" };
        builder.partitionComponentsInternal(partitionKey).getLastMatchingWithLimit(6, clusteringComponents);
    ...
    public void should_get_iterator_with_components() throws Exception {
        ...
        when(sliceQueryExecutor.iterator(anySliceQuery())).thenReturn(iterator);
        Iterator<ClusteredEntity> actual = builder.partitionComponentsInternal(partitionKey).iteratorWithMatching(
                clusteringComponents);
    ...
    public void should_get_iterator_with_batch_size_and_components() throws Exception {
        ...
        when(sliceQueryExecutor.iterator(anySliceQuery())).thenReturn(iterator);
        Iterator<ClusteredEntity> actual = builder.partitionComponentsInternal(partitionKey).iteratorWithMatchingAndFetchSize(7,
                clusteringComponents);
