...
public class ClusteredEntityWithCompositePartitionKeyIT {
    ...
    public void should_query_with_getFirst() throws Exception {
        ...
        List<ClusteredEntityWithCompositePartitionKey> entities = manager
                .sliceQuery(ClusteredEntityWithCompositePartitionKey.class).partitionComponents(id, "type").getFirstMatchingWithLimit(3);
    ...
    public void should_query_with_getLast() throws Exception {
        ...
        ClusteredEntityWithCompositePartitionKey entity = manager
                .sliceQuery(ClusteredEntityWithCompositePartitionKey.class).partitionComponents(id, "type").getLastMatching();
        ...
        List<ClusteredEntityWithCompositePartitionKey> entities = manager
                .sliceQuery(ClusteredEntityWithCompositePartitionKey.class).partitionComponents(id, "type").getLastMatchingWithLimit(3);
