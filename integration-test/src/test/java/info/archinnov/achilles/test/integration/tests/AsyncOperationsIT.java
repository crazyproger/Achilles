...
public class AsyncOperationsIT {
    ...
    public void should_persist_many() throws Exception {
        ...
        final AchillesFuture<CompleteBean> futureEntity1 = manager.asyncPersist(paul, withAsyncListeners(callback));
        final AchillesFuture<CompleteBean> futureEntity2 = manager.asyncPersist(george);
        final AchillesFuture<CompleteBean> futureEntity3 = manager.asyncPersist(michael);
    ...
    public void should_persist_with_success_and_error_async() throws Exception {
        ...
        //When
        manager.asyncPersist(george, withAsyncListeners(successCallBack));
        manager.asyncPersist(paul, withAsyncListeners(errorCallBack).ifNotExists());
    ...
    public void should_find_many() throws Exception {
        ...
        final AchillesFuture<CompleteBean> future1 = manager.asyncFind(CompleteBean.class, entity1.getId(), withAsyncListeners(successCallBack));
        final AchillesFuture<CompleteBean> future2 = manager.asyncFind(CompleteBean.class, entity2.getId());
        final AchillesFuture<CompleteBean> future3 = manager.asyncFind(CompleteBean.class, entity3.getId());
    ...
    public void should_update_modifications() throws Exception {
        ...
        CompleteBean managedPaul = manager.persist(paul);
        managedPaul.setAge(102L);
        managedPaul.getFriends().add("oscar");
        managedPaul.getPreferences().put(1, "CA");

        CompleteBean managedGeorge = manager.persist(george);
        managedGeorge.setAge(103L);
        managedGeorge.getFriends().add("mallory");
        managedGeorge.getPreferences().put(2, "Seattle");

        final AchillesFuture<CompleteBean> futureJonathan = manager.asyncUpdate(managedJonathan, withAsyncListeners(successCallBack));
        final AchillesFuture<CompleteBean> futurePaul = manager.asyncUpdate(managedPaul);
        final AchillesFuture<CompleteBean> futureGeorge = manager.asyncUpdate(managedGeorge);
    ...
    public void should_remove_many() throws Exception {
        ...
        final AchillesFuture<CompleteBean> futurePaul = manager.asyncRemove(paul, withAsyncListeners(successCallBack));
        final AchillesFuture<CompleteBean> futureJack = manager.asyncRemove(jack);
        final AchillesFuture<CompleteBean> futureJohn = manager.asyncRemove(john);
    ...
    public void should_refresh_many() throws Exception {
        ...
        final AchillesFuture<CompleteBean> futurePaul = manager.asyncRefresh(paul, withAsyncListeners(successCallBack));
        final AchillesFuture<CompleteBean> futureJohn = manager.asyncRefresh(john);
        final AchillesFuture<CompleteBean> futureJack = manager.asyncRefresh(jack);
